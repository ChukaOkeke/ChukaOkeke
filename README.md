...
| **Observability** | OpenTelemetry (ADOT), Prometheus, Grafana, AWS X-Ray, CloudWatch |
| **Programming & Scripting** | Python, Bash |
| **Security & Compliance** | IAM, Network Security, Secrets Management, SAST, SCA, Container Security, DAST |
